...
def bengalimaincheckout(request):
    ...
    context={'total_price':total_price,'userprofile':userprofile}
    return render(request,'bengali-store/maincheckout.html',context)

@login_required(login_url='russianlogin')
def russianmaincheckout(request):
...
def indonesianmaincheckout(request):
...
def telugumaincheckout(request):
    ...
    context={'total_price':total_price,'userprofile':userprofile}
    return render(request,'telugu-store/maincheckout.html',context)

@login_required(login_url='turkishlogin')
def turkishmaincheckout(request):
...
def vietnamesemaincheckout(request):
    ...
    context={'total_price':total_price,'userprofile':userprofile}
    return render(request,'vietnamese-store/maincheckout.html',context)

@login_required(login_url='tagaloglogin')
def tagalogmaincheckout(request):
...
def egyptianmaincheckout(request):
    ...
    context={'total_price':total_price,'userprofile':userprofile}
    return render(request,'egyptian-store/maincheckout.html',context)